...
This is the geophysical analog of the Multiband Image encoding.
...
The adoption of this document relies on its quality and applicability which greatly depends on community feedback. Below are several ways how to contribute to its development:

* The document is hosted in a GitHub https://github.com/Unidata/EC-netCDF-CF[repository^] and the most up-to-date version can be viewed http://gist.asciidoctor.org/?github-Unidata%2FEC-netCDF-CF%2F%2Fswath%2Fswath.adoc[here^].

* Test swath files are available for both the examples in this document (https://eosdap.hdfgroup.org:8080/opendap/data/earth-cube-cf2/swath/contents.html[Hyrax^], https://eosdap.hdfgroup.org:8888/thredds/catalog/testAll/cf2/swath/catalog.html[THREDDS^]) and real community-supplied files (https://eosdap.hdfgroup.org:8080/opendap/data/earth-cube-cf2/swath-real/contents.html[Hyrax^], https://eosdap.hdfgroup.org:8888/thredds/catalog/testAll/cf2/swath-real/catalog.html[THREDDS^]).
...
* Describing field-of-view geospatial extents can be used in all swath encodings.
