...
====
Proposal status: *[red]#FINAL DRAFT/2018-??-??#*.
====
...
* Added a diagram depicting a hyperspectral sounding instrument's observation goemetry.
|===
